...
<head>
    ...
    <title>素材火www.sucaihuo.com - Bootstrap3 Markdown编辑器</title>
            ...
            <div class="row border-bottom">
                <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
                    <div class="navbar-header">
                        <a class="navbar-minimalize minimalize-styl-2 btn btn-primary " href="form_markdown.html#"><i class="fa fa-bars"></i> </a>
